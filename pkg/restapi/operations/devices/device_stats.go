...
type DeviceStatsHandlerFunc func(DeviceStatsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeviceStatsHandlerFunc) Handle(params DeviceStatsParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeviceStatsHandler interface for that can handle valid device stats params
type DeviceStatsHandler interface {
	Handle(DeviceStatsParams, interface{}) middleware.Responder
}
